...
const WhyHumu = () => {
  return (
    <section className="relative z-20 md:-mt-[45%] lg:-mt-[35%]">
      ...
      <div className="absolute  left-[1.25rem] top-0 md:top-60 md:left-10 lg:top-72 xl:top-[30rem] 2xl:top-[42rem]   2xl:left-[5.5rem] flex flex-col md:flex-row w-[90%] gap-6 lg:gap-14 xl:gap-32 2xl:gap-96 mx-auto">
        <div className=" xl:-mt-24">
          ...
          <div className="grid md:grid-cols-2 gap-2  2xl:gap-8 md:w-[425px] lg:w-[510px] xl:mt-40 xl:w-[500px] 2xl:w-[1064px]">
            <div className="rounded-[32px] flex   bg-[#BCD2FF] p-3.5 2xl:p-6 md:py-4 lg:text-center min-h-[140px] xl:min-h-[190px] 2xl:h-[390px]">
              <div className="items-start">
                <div className="flex gap-2 text-xl font-extrabold items-center 2xl:mb-4 xl:mt-4 2xl:mt-16">
                  <Image
            ...
            <div className="rounded-[32px] flex bg-[#BCD2FF] p-3.5 2xl:p-6 md:p-4 min-h-[140px] lg:text-center md:min-h-[200px]">
              <div className="">
                ...
                <p className="md:pb-16 2xl:w-fit 2xl:mx-auto 2xl:text-[26px] ">
              ...
              <div className="">
                <div className="flex gap-[0.4rem] md:pt-4 font-extrabold md:mx-auto  xl:w-[211px]  2xl:w-fit 2xl:mb-4 items-center xl:mt-4 2xl:mt-16">
                  <Image
                    ...
                    alt="profile"
                  />
                  <h4 className="w-fit xl:w-[300px] text-2xl md:text-base 2xl:text-3xl">
                    Voice & video profile
                  </h4>
                </div>
