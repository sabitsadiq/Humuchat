...
import MeetPartner1 from "../components/MeetPartner1";
...
const MeetPartner = () => {
  return (
    ...
    //     </div>
    //   </div>
    //   <div className="px-6   md:w-[60%] md:h-fit xl:h-[112px]  lg:w-[48%]  mx-auto lg:mt-8 lg:-mb-8 mb:pt-12 flex flex-col items-start md:center md:items-center">
